<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/pro/produzione.Master" CodeBehind="proConfirmProduction.aspx.vb" Inherits="servisWO.proConfirmProduction" %>
...
<dx:PopupControlContentControl runat="server" SupportsDisabledAttribute="True"></dx:PopupControlContentControl>
    ...
    <dx:ASPxGridView ID="gridOrders" runat="server" Theme="BlackGlass" AutoGenerateColumns="False" Width="100%">
    ...
    <SettingsDataSecurity AllowDelete="False" AllowEdit="False" AllowInsert="False" />
        <Columns>
            <dx:GridViewDataTextColumn Caption="Ordine" FieldName="Code" VisibleIndex="0" Width="120px">
             ...
             <dx:GridViewDataTextColumn Caption="Cliente" FieldName="CODICECLIENTE" VisibleIndex="1" Width="140px">
            </dx:GridViewDataTextColumn>
