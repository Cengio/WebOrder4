...
Partial Public Class datamanager
    ...
    Private BCconnectionString As String = [String].Empty
    ...
    Public Sub New()
        ...
        BCconnectionString = ConfigurationManager.ConnectionStrings("BCconnectionString").ToString
    ...
    Public ReadOnly Property GetBCconnectionString() As String
        Get
            Return BCconnectionString
        End Get
    End Property
