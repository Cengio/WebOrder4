Partial Class Report1
    ...
    Private Sub InitializeComponent()
        ...
        Me.TextBox61.Value = "='Questo ordine è stato inserito da '+Fields.OperatorCode+' ed elaborato da '+Fie" &
    "lds.User"
        '
        'TextBox64
        '
