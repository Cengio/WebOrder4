<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="orderReport.aspx.vb" Inherits="servisWO.orderReport" %>
...
<body>
    ...
    <div>
        ...
        <dx:ReportViewer ID="ReportViewer1" runat="server" Theme="MetropolisBlue">
        </dx:ReportViewer>
